...
##### 3. Principal component 1 grouped by industry sector
...
out <- weight1 %>% group_by(sector) %>% summarize(comp1 = mean(comp1))
str(out)
#barplot(out)
...
##### 4. Principal component 2 grouped by industry sector
